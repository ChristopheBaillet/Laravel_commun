...
@section('content')
    ...
    <form class="row g-3" method="post" action="{{route('backofficeProductStore')}}">
        {{csrf_field()}}
        <div class="col-md-6">
        ...
        <div class="col-md-12">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="image" name="image" aria-describedby="inputGroupPrepend2"
        ...
        <div class="col-md-3">
            ...
            <input type="number" class="form-control" id="weight" name="weight" required placeholder="Weight">
        </div>
        <div class="col-md-3">
